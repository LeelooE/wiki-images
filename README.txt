...
5. Description of AsPreducted.pdf (AsPredicted (for peer-review only) #68156)
	- Pre-registered experiment document.

6. Description of Supplementary_Results.pdf
	- Supplemental results that include practice round question data as part of the entire analysis for the experiment.
